...
class SimpleDemo {
    ...
    public function doGet() {
        ...
        $request = new Request('GET', 'http://xqokj9u7k483.cn-north-1.jdcloud-api.net/iamget',
            [
                'query' => 'name=test',
                'x-my-header' => 'test',
            ]
    ...
    public function doPostBigBody() {
        ...
        $request = new Request('POST', 'http://xqokj9u7k483.cn-north-1.jdcloud-api.net/iampost',
            [
                ...
                'body' => 'assume I am big body, thus i donot want body to sign, I pass header x-jdcloud-Content-Sha256: UNSIGNED-PAYLOAD'
            ]
            );
        $signedRequest = $signature->signRequest($request, $credentials);
